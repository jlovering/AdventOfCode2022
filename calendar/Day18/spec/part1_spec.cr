...
describe ds.dayShortName do
    describe "Part1", tags: "part1" do
        it "sample test case", tags: "example" do
            p1 = Part1.new(ds.dayPath.to_s + "/input/sample.txt")
            p1.run.should eq("10")
        end
        ...
        it "part1 Tim solution submit", tags: ["solution", "submit"] do
            p1 = Part1.new(ds.dayPath.to_s + "/input/tim_input.txt")
            result = p1.run
            Spec.after_suite {
